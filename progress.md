...
| 2026-06-30 | Narrowed target audience to faculty-only. Updated overview.md, features.md, llm-integration.md, auth-security.md, domain-knowledge.md, and src/app.py. Added anti-injection rule to app.py system prompt. Domain constraints refined for faculty sub-categories (tenure-track vs. adjunct vs. clinical). |
